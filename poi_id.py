...
### Summary of the breakdown of the data by POI/Non-POI: 
print "# of Non-POI cases: ",datacount(data_dict,'poi',False,"equal")
print "# of POI cases: ",datacount(data_dict,'poi',True,"equal")           
...
plot_features(data_clean_1,features_list,1,3,"perc_from_poi","perc_shared_receipt",0)
...
data_clean_2 = featureFormat(data_dict, features_list)
...
plot_features(data_clean_4,features_list,4,6,"salary","total_stock_value",0)

#### What is this top right outlier? Well, Ken Lay - that's a legit point.
print listbycriteria(data_dict_wo_total,'total_stock_value',45000000,">")
...
#### It did, but by reducing the data points by almost half, so kept the data in.
